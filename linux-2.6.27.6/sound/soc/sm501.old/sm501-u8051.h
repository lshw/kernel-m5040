...
typedef struct
{
    ...
    union
    {
        struct
        {
            ...
            unsigned char playback_buffer_1[SM501_AC97_P_PERIOD_SIZE];    /* 0x3800 */
        }B;
        struct
        {
            unsigned char filler[0x0800];               /* 0x3000 */
            unsigned char capture_buffer_0[0x0300];     /* 0x3800 */
            unsigned char capture_buffer_1[0x0300];     /* 0x3B00 */
        }C;
    }A;
